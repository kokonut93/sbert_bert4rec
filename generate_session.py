...
# 2. Generating Region A Dataset by mapping values
...
# Step 1: Split the 'prev_items' column using space as the delimiter
...
# Step 2: Create new columns and allocate each string from 'prev_items' to a different column
